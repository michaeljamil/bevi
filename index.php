...
function calculatePrice(productName, size, addOns) {
    ...
    switch (productName) {
        case 'Coffee':
            basePrice = 79; // Base price for Coffee
            break;
        case 'Iced Coffee':
            basePrice = 85; // Base price for Iced Coffee
            break;
        case 'Milktea':
            basePrice = 85; // Base price for Milktea
            break;
        case 'Iced Tea':
            basePrice = 79; // Base price for Iced Tea
            break;
        case 'Frappe':
            basePrice = 90;
            break;
        case 'Soda':
            ...
            break;
        default:
            basePrice = 0; // Default base price if product name is not recognized
    }
    ...
    let totalPrice = basePrice + sizePrice + addOnsPrice;
    return totalPrice;
}
